...
This means the CoM always converges toward the DCM — a powerful property
for control design.
...
- J. Pratt et al., "Capture Point: A Step toward Humanoid Push Recovery," *Proc. IEEE-RAS Humanoids*, 2006.
- J. Englsberger et al., "Three-Dimensional Bipedal Walking Control Based on Divergent Component of Motion," *IEEE Trans. Robotics*, 2015.
- T. Koolen et al., "Capturability-based analysis and control of legged locomotion," *Int. J. Robotics Research*, 2012.
