...
input. The state vector is $\mathbf{x} = [x, \dot{x}, \ddot{x}]^T$, giving
...
- T. Katayama et al., "Design of an optimal controller for a discrete-time system subject to previewable demand," *Int. J. Control*, 1985.
