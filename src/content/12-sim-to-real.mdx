...
- J. Tobin et al., "Domain Randomization for Transferring Deep Neural Networks from Simulation to the Real World," *Proc. IROS*, 2017.
- I. Radosavovic et al., "Real-World Humanoid Locomotion with Reinforcement Learning," *Science Robotics*, 2024.
